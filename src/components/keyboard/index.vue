<template>
  <div>
		<textarea :class="cn" v-if="options.type === 'textarea'" ref="keyboardRef"/>
    <input :class="cn" v-else ref="keyboardRef"  />
  </div>
</template>
...
export default {
  ...
  mounted () {
    ...
    this.options.visible = () => {
      this.cn = this.className + ' keyboard-wrapper open'
    }
    this.options.hidden = () => {
      this.cn = this.className +' keyboard-wrapper'
    }
